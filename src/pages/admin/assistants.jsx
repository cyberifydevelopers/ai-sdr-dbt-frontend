...
export default function AssistantList() {
  ...
  // last created (from filtered list)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50">
      ...
      <div className="relative overflow-hidden">
        ...
        />
        <div className="relative mx-auto w-full max-w-[1400px] px-6 py-12">
          <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <button
                onClick={() => navigate("/admin/addassistands")}
                ...
                <thead className="bg-gray-50/60">
                  <tr>
                    ...
                    <ModernTh
                      ...
                      onSort={toggleSort}
                    />
                    <th className="w-[18%] px-6 py-4 text-center text-sm font-semibold text-gray-700">Actions</th>
                  </tr>
                </thead>
                  ...
                  {pageData.map((a) => (
                    ...
                    >
                      ...
                      <td className="w-[24%] px-6 py-4">
                        <div className="flex items-center gap-4">
                          ...
                          <div className="min-w-0">
                            <div className="max-w-[32ch] truncate font-semibold text-gray-900 transition-colors group-hover:text-blue-700">
                              {a.name || "—"}
                            </div>
                      ...
                      <td className="w-[12%] px-6 py-4">
                        <div className="mx-auto max-w-[22ch] truncate text-center">
                      ...
                      <td className="w-[16%] px-6 py-4">
                        <div className="flex items-center justify-center gap-2">
                          <span className="font-mono text-sm text-gray-700 break-all">{a.attached_Number || "—"}</span>
                          {a.attached_Number && (
                            <button
                      ...
                      {/* Created */}
                      <td className="w-[8%] px-6 py-4 text-center text-sm text-gray-600 whitespace-nowrap">
                        {a.created_at ? new Date(a.created_at).toLocaleDateString() : "—"}
                      </td>

                      {/* Actions */}
                      <td className="w-[18%] px-6 py-4">
                        <div className="mx-auto flex w-full items-center justify-center gap-2 whitespace-nowrap">
                          <ModernActionButton
                            title="Edit Assistant"
                            onClick={() => navigate(`/admin/edit-assistants/${a.id}`)}
                            variant="primary"
                          >
            ...
            <div className="space-y-4 xl:hidden">
              {pageData.map((a) => (
                <ModernMobileCard
                  ...
                  onEdit={() => navigate(`/admin/edit-assistants/${a.id}`)}
    ...
    >
      ...
      <div className="mb-4 grid grid-cols-2 gap-4 text-sm">
        ...
        <div>
          ...
          <div className="font-mono text-sm break-all">{assistant.attached_Number || "—"}</div>
        </div>
        <div>
